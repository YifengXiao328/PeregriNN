...
class Poset(object):
    def __init__(self, input_domain, A, b):
        #input bounding box
        self.input_domain = input_domain
        self.A = A
        self.b = b 
        A_,b_, minimal_set = minimal_H_cdd(self.A, self.b, self.input_domain)
    ...
    def get_neighbours(self, pNode):
        ...
        for f_idx in range(len(pNode.faces)):
            ...
            A_,b_, minimal_set = minimal_H_cdd(A_all,b_all,self.input_domain)
            if(A_ is None):
                continue
